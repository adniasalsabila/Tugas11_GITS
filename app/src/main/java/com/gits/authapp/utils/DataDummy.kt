...
object DataDummy {
    fun getMovie(): List<DataMovieTvshow> {
        val dataMovie = ArrayList<DataMovieTvshow>()
        ...
        dataMovie.add(
                DataMovieTvshow(
                        ...
                        "Seasoned musician Jackson Maine discovers — and falls in love with — struggling artist Ally. She has just about given up on her dream to make it big as a singer " +
                                "— until Jack coaxes her into the spotlight. But even as Ally's career takes off, the personal side of their relationship is breaking down, as Jack fights " +
        ...
        dataMovie.add(
                DataMovieTvshow(
                        ...
                        "The quiet family life of Nels Coxman, a snowplow driver, is upended after his son's murder. " +
                                ...
                                "eliminating Viking's associates one by one. As Nels draws closer to Viking, his actions bring " +
                                "even more unexpected and violent consequences," +
        ...
        dataMovie.add(
                DataMovieTvshow(
                        ...
                        "69%",
                        "Drama",
                        "Between personal obligations and training for his next big " +
                                "fight against an opponent with ties to his family's past, " +
        ...
        dataMovie.add(
                DataMovieTvshow(
                        ...
                        "Gellert Grindelwald has escaped imprisonment and has begun gathering followers to his" +
                                " cause—elevating wizards above all non-magical beings. The only one capable of putting " +
                                "a stop to him is the wizard he once called his closest friend, Albus Dumbledore. However, " +
                                "Dumbledore will need to seek help from the wizard who had thwarted Grindelwald once before, his former student Newt Scamander, who agrees to help, unaware of the dangers that lie ahead. Lines are drawn as love and loyalty are tested, " +
    ...
    fun getTvshow(): List<DataMovieTvshow> {
        val dataTvshow = ArrayList<DataMovieTvshow>()
        ...
        dataTvshow.add(
                DataMovieTvshow(
                        ...
                        "Spoiled billionaire playboy Oliver Queen is missing and presumed dead when " +
                                "his yacht is lost at sea. He returns five years later a changed man, " +
        ...
        dataTvshow.add(
                DataMovieTvshow(
                        ...
                        "The Doom Patrol’s members each suffered horrible accidents that gave " +
                                "them superhuman abilities — but also left them scarred and disfigured. " +
                                "Traumatized and downtrodden, the team found purpose through The Chief, " +
                                "who brought them together to investigate the weirdest " +
                                "phenomena in existence — and to protect Earth from what they find.",
        ...
        dataTvshow.add(
                DataMovieTvshow(
                        ...
                        "Seven noble families fight for control of the mythical land of Westeros. " +
                                ...
                                "Amidst the war, a neglected military order of misfits, the Night's Watch, is " +
        ...
        dataTvshow.add(
                DataMovieTvshow(
                        ...
                        "This thriller and coming-of-age drama follows the journey of an " +
                                "extraordinary young girl as she evades the relentless pursuit of " +
                                "an off-book CIA agent and tries to unearth " +
                                "the truth behind who she is. Based on the 2011 Joe Wright film.",
    ...
    fun movieDetail(id: Int): DataMovieTvshow = getMovie()[id]
    fun tvShowDetail(id: Int): DataMovieTvshow = getTvshow()[id]
}